...
class Attention_org(nn.Module):
    def __init__(self, channel_num):
        ...
        self.select1 = channel_selection(self.KV_size)
...
class Mlp(nn.Module):
    def __init__(self, in_channel, mlp_channel):
        ...
        self.select2 = channel_selection(mlp_channel)
...
class ChannelTransformer_light(nn.Module):
    def __init__(self, img_size, channel_num, patchSize):
        super().__init__()
        ...
        self.encoder = Encoder(new_channel_num)
